...
namespace WpfApp4
{
    internal class Encrypt
    {
        ...
        public string Unencrypting(string text)
        {
            int index = 0;
        ...
        public void oldEncrypting()
        { }
        public void oldUnEncrypting()
        { }
    }
}
